...
let newSum = (a, b, c, d) => ` ${a} + ${b} + ${c} + ${d} = ${a + b + c + d}`;

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sum(1, 2, 3, 4));
console.log('this is the new sum', newSum(1,2,3,4));
...
console.log('this is the new object list', newObjList());
...
console.log('this is the new sum and product', newSumAndProduct(3, 9));
...
console.log('this is the new message', newMessage('Allie'));
...
class NewStudent {
    ...
    constructor(names, age, hometown) {
    this.names = names;
    this.age = age;
    this.hometown = hometown;
    }

    print = () => `${this.names}, ${this.age}, ${this.hometown}`;


    greet = () => `Hi, my name is ${this.names}`;

    course = () => `new solution:::  This student is enrolled in Code 301.`;

} 
let joe2 = new NewStudent("jjjjj",20,"amman");
...
//it is showing the different values based on the situation or things that the function is called (the obj that called the function).


// 2. What is "this" when joe.scopeArrow() is invoked?
// it is use the value of this in their lexical scope 
//(it shows all the variables visible to a function where it is defined,
//and it shows things is already called, and the other things who it didnt called and how it is defined).


// 3. Explain why "this" is different when an arrow function is used.
//because it shows all the variables visible to a function where it is defined,
//and it shows things is already called, and the other things who it didnt called and how it is defined).